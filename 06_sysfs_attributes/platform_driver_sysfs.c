...
/*
    Sysfs attribute lecture pending from part 2
*/
// Creating 2 Variables of device attributes
// static DEVICE_ATTR(max_size)
...
struct psuedo_char_dev_platform_data * dev_get_platdata_from_dt(struct device *dev){
    ...
    if(of_property_read_string(dev_node,"org,device_serial",&pdata->serial_number)){
